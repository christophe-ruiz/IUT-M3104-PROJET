<nav class="corps">
    ...
    <div class="presentation">
        <p>
            Notre site est un réseau social novateur. Les discussions peuvent au maximum contenir <?= unserialize($_SESSION['maxMSG']) ?> réponse<?php if (unserialize($_SESSION['maxMSG']) > 1) echo 's'; ?> chacune composée de 1 ou 2 mots.
